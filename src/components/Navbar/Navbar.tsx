...
export const Navbar= ({className, ...props}: NavbarProps)=> {
  return (
    ...
    <nav
      {...props}
      className={cn("fixed top-0 left-0 flex h-screen flex-col bg-slate-900 border-r border-indigo-400/20 hover:border-indigo-400/40 w-72 p-2 text-slate-300", className)}
      >
      <div
